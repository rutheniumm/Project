...
TypeDefs = loadstring(
	game:GetService "HttpService":GetAsync("https://raw.githubusercontent.com/rutheniumm/Project/refs/heads/main/TypeDefinitions.lua")
)()
...
typeof = loadstring(
	game:GetService "HttpService":GetAsync("https://raw.githubusercontent.com/rutheniumm/Project/refs/heads/main/TypeMarshaller.lua")
)()-----------------------------------------------------------
-------------------- MODULE DEFINITION --------------------
-----------------------------------------------------------
...
table = loadstring(
	game:GetService "HttpService":GetAsync("https://raw.githubusercontent.com/rutheniumm/Project/refs/heads/main/Table.lua")
)()
